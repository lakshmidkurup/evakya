...
##                #print(sentence)
        ...
        if option == 2:   # Rule2 : A comma (,) is used to separate the conjunctive adverb from the sentence
            if cadv=="however":
                ...
                type3=perspro,hverb,neg,cverb,pro
                subclause=comma+" "+s.join(type3)+period
                cadv=cadv.capitalize()
                sentence=type1+comma+" "+text2+period+" "+cadv+subclause
                #print(sentence)
