...
class qmrules:
    def qmdetails1(b,c,correct,category,level,username,userid,eid,submittedtext):
            ...
            from questionmarkrules import qmrules as qmr
            if no_at==0:
                hintls1t1=[]
                mandlst1=[]
                correctlst1=[]
                submittedtext = request.form.get("text")
                hintlst1,mandlst1,correctlst1,mandatory=qmr.qmone(b,c,correct,category,level,session['username'],session['id'], eid,submittedtext)
...
#-----------------------------------------------------------------------2nd attempt--------------------------------------------------------------------------
                ...
                mandlst2=[]
                correctlst2=[]
                hintlst2,mandlst2,correctlst2,mandatory=qmr.qmtwo(b,c,correct,category,level,session['username'],session['id'], eid,submittedtext)
...
#------------------------------------------------------------------3rd attempt---------------------------------------------------------------------------------------------                
                ...
                correctlst3=[]
                hint=""
                hintlst3,mandlst3,correctlst3,mandatory=qmr.qmthree(b,c,correct,category,level,session['username'],session['id'], eid,submittedtext)
