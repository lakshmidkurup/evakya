...
class commaf:
    def commadetails1(b,c,correct,category,level,username,userid,eid,submittedtext):
            ...
            if no_at==0:
                ...
                hintlst1,mandlst1,correctlst1,mandatory=cr.commaone(b,c,correct,category,level,session['username'],session['id'], eid,submittedtext)
...
#-----------------------------------------------------------------------2nd attempt--------------------------------------------------------------------------
                ...
                mandlst2=[]
                correctlst2=[]
                hintlst2,mandlst2,correctlst2,mandatory=cr.commatwo(b,c,correct,category,level,session['username'],session['id'], eid,submittedtext)
...
#------------------------------------------------------------------3rd attempt---------------------------------------------------------------------------------------------                
                ...
                correctlst3=[]
                hint=""
                hintlst3,mandlst3,correctlst3,mandatory=cr.commathree(b,c,correct,category,level,session['username'],session['id'], eid,submittedtext)
 ...
 #-----------------------------------------------max score of previous click--------------------------------------------------------------------------------------------------------------------
    ...
    def commadetails2(b,c,correct,category,level,username,userid,eid,submittedtext):
               #----------------------------------#print no:of attempts--------------------------------------------------------------------------------------------------
            ...
            from quotcommarules import quotcrules as qcr
            if no_at==0:
                hintls1t=[]
                mandlst1=[]
                correctlst1=[]
                submittedtext = request.form.get("text")
                hintlst1,mandlst1,correctlst1,mandatory=qcr.commaone(b,c,correct,category,level,session['username'],session['id'], eid,submittedtext)
                print("mandatory",mandatory)
                for hint in hintlst1:
...
#-----------------------------------------------------------------------2nd attempt--------------------------------------------------------------------------
                ...
                mandlst2=[]
                correctlst2=[]
                hintlst2,mandlst2,correctlst2,mandatory=qcr.commatwo(b,c,correct,category,level,session['username'],session['id'], eid,submittedtext)
                print("mandatory",mandatory)
                for hint in correctlst2:
...
#------------------------------------------------------------------3rd attempt---------------------------------------------------------------------------------------------                
                ...
                correctlst3=[]
                hint=""
                hintlst3,mandlst3,correctlst3,mandatory=qcr.commathree(b,c,correct,category,level,session['username'],session['id'], eid,submittedtext)
                print("hintlst3",hintlst3)
                print("mandlst3",mandlst3)
                print("correctlst3",correctlst3)      
                for hint in correctlst3:
 ...
 #-----------------------------------------------max score of previous click--------------------------------------------------------------------------------------------------------------------
    ...
    def commadetails3(b,c,correct,category,level,username,userid,eid,submittedtext):
               #----------------------------------#print no:of attempts--------------------------------------------------------------------------------------------------
            #----------------------------------#print no:of attempts--------------------------------------------------------------------------------------------------
            cursor = mysql.connection.cursor(MySQLdb.cursors.DictCursor)
            sql_select_query = 'select max(nattempts) from exercisedetails where userid= %s and exerciseid=%s'
            ...
            from type12commarules import type12crules as tcr
            if no_at==0:
                hintls1t1=[]
                mandlst1=[]
                correctlst1=[]
                submittedtext = request.form.get("text")
                hintlst1,mandlst1,correctlst1,mandatory=tcr.commaone(b,c,correct,category,level,session['username'],session['id'], eid,submittedtext)
...
#-----------------------------------------------------------------------2nd attempt--------------------------------------------------------------------------
                ...
                mandlst2=[]
                correctlst2=[]
                hintlst2,mandlst2,correctlst2,mandatory=tcr.commatwo(b,c,correct,category,level,session['username'],session['id'], eid,submittedtext)
                print("mandatory",mandatory)
                for hint in correctlst2:
...
#------------------------------------------------------------------3rd attempt---------------------------------------------------------------------------------------------                
                ...
                correctlst3=[]
                hint=""
                hintlst3,mandlst3,correctlst3,mandatory=tcr.commathree(b,c,correct,category,level,session['username'],session['id'], eid,submittedtext)
                print("hintlst3",hintlst3)
                print("mandlst3",mandlst3)
                print("correctlst3",correctlst3)      
                for hint in correctlst3:
