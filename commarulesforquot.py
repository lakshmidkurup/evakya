...
class commarules1:
    def commadetails1(b,c,correct,category,level,session['username'],session['id'], eid,submittedtext):
...
#------------------------------------------------------------------3rd attempt---------------------------------------------------------------------------------------------                
 ...
 #-----------------------------------------------max score of previous click--------------------------------------------------------------------------------------------------------------------
    ...
    def commadetails2(b,c,correct,category,level,session['username'],session['id'], eid,submittedtext):
               #----------------------------------#print no:of attempts--------------------------------------------------------------------------------------------------
            sql_select_query = 'select max(nattempts) from exercisedetails where userid= %s and exerciseid=%s'
            cursor.execute(sql_select_query, (session['id'],eid,))
            na= cursor.fetchone()             
